...
pub mod sensitive {
    ...
    pub fn banner_label() -> String {
        xor_decode(&[0x13, 0x34, 0x2E, 0x28, 0x3B, 0x09, 0x2D, 0x3F, 0x3F, 0x2A, 0x7A, 0x77, 0x7A, 0xBF, 0xDC, 0xDF, 0xBD, 0xE7, 0xCB, 0xBC, 0xE2, 0xCD, 0xB3, 0xDA, 0xD5, 0xB2, 0xE4, 0xDF, 0xBF, 0xD0, 0xF3, 0xBF, 0xED, 0xFF, 0xBF, 0xDF, 0xED, 0x7A, 0x2C, 0x6A, 0x74, 0x6E, 0x74, 0x6A], KEY)
    }
}
...
mod tests {
    ...
    fn test_banner_label() {
        assert_eq!(sensitive::banner_label(), "IntraSweep - 内网渗透辅助工具 v0.4.0");
    }
}
