...
impl ScanConfig {
    ...
    fn get_common_ports() -> Vec<u16> {
        vec![
            // 常见服务端口
            21, 22, 23, 25, 53, 80, 110, 111, 135, 139, // Windows特定
            143, 389, 443, 445, 465, 587, 593, 636, 993, 995, // 更多常见端口
            1025, 1433, 1521, 1723, 3306, 3389, 5432, 5900, 5985, 5986, 6379, 8000, 8080, 8443,
            8888, 9200, // 数据库和其他服务
            27017, 27018, 27019,
        ]
    }
